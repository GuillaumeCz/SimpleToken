  ...
  it('...should create 2 SimpleTokens', () => {
    ...
    return SimpleToken.deployed()
      .then(instance => {
        ...
        const pr0 = stInstance.createSimpleToken.sendTransaction(owner0, owner1, details0);
        const pr1 = stInstance.createSimpleToken.sendTransaction(owner1, owner0, details1);
